package com.mahout.demoVersion;
import java.io.File;
...
public class MyItemBasedRecommender {
	...
	public static void main(String[] s) throws Exception{
		DataModel model = new FileDataModel(new File("/Users/xujing/Documents/workspace/demoVersion/src/main/java/com/mahout/demoVersion/data.csv"));//构造数据模型，File-based
